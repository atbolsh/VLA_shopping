...
| 2 | [`molmoact2`](molmoact2/README.md) | ~20 GB Think + ~16 GB Molmo2-ER | **Next on a 1×5090.** Depth-token think + official VQA |
| 3 | [`internvla_n1`](internvla_n1/README.md) | ~16 GB DualVLN + ~16 GB System2 | Pixel-goal + S2 text — needs **2×5090** |
