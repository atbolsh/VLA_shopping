...
5. `notes/09_next_session.md` — English-while-acting crop. **Build-out 2026-09-05: EO-1 + LIBERO** (see repo `README.md`). Do not reopen ChatVLA / WALL-OSS / ECoT / Bridge VM as the next box. First crop **rejected 2026-09-04**. InternVLA-N1 is **never** the next box. Sibling log: `notes/10_sibling_list.md`.
